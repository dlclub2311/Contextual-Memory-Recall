...
class PODNet(ICarl):
    ...
    def _train_task(self, train_loader, val_loader):
        ...
        #_, train_loader = self.inc_dataset.get_custom_loader(list(range(self._n_classes)), mode="train") #------------------Added YK
    ...
    def _compute_loss(self, inputs, outputs, targets, onehot_targets, memory_flags):
        ...
        if self._old_model is not None and False:
            with torch.no_grad():
        ...
        if self._old_model is not None and False: # and False: #for podnet
